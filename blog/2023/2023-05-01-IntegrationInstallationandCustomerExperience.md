...
As the integration provider you want a great customer experience so you use the <a href="https://docs.anthology.com/docs/REST%20APIs/Learn/Admin/rest_apis-learn-admin-rest_and_learn#converting-entitlements-to-gui-privileges" target="_top"> bookmarklet tool</a> to determine the privileges you include in your documentation to provide guidance to admins installing your integration.
