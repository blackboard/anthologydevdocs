...
from the OpenLDAP project. The key difference is the salt-size. Blackboard LMS uses an **8-byte** salt. OpenLDAP uses
...
1. For each password: create 8 random bytes of 'salt'. Never re-use salts. Use a Cryptographically Secure Pseudo-Random
