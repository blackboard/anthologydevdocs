...
- **2-UEF-MESSAGECHANNEL**: In this branch, we implement all the JavaScript we need to create a message channel for your application and Ultra to begin talking
...
<ReactPlayer playback={false} controls url="https://www.youtube.com/embed/Mp9tFpultaQ" />
...
<ReactPlayer playback={false} controls url="https://www.youtube.com/embed/rpUuUpK8MtQ" />
...
16. Create a directory outside your project, and copy these four files, Config.py, lti.json, public.key and private.key, and paste them there to prevent accidental loss of these files so you don't have to recreate them later.
...
<ReactPlayer playback={false} controls url="https://www.youtube.com/embed/vdXw3sztpz8" />
...
<ReactPlayer playback={false} controls url="https://www.youtube.com/embed/siGD6-FX2uw" />
...
<ReactPlayer playback={false} controls url="https://www.youtube.com/embed/NmFLNAYwFOw" />
...
Now that we have our development environment set up and configured, it is time to get to work! A couple of notes to help you navigate this tutorial.
...
In the first step, we will make a few minor changes to our LTI tool to create an Ultra Extension Framework shell running in our Learn instance!

<ReactPlayer playback={false} controls url="https://www.youtube.com/embed/6AcBJkJkgYY" />
...
<ReactPlayer playback={false} controls url="https://www.youtube.com/embed/YFW-C_bJcjs" />
...
<ReactPlayer playback={false} controls url="https://www.youtube.com/embed/VcSpyZBehJU" />
...
<ReactPlayer playback={false} controls url="https://www.youtube.com/embed/bvfD_Hnf2So" />
