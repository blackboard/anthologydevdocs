...
- MeetingPatterns - this property is a collection of type ClassSectionMeetingPatternEntity.
    ...
    - MeetingPattern - this is a complex type - ClassSectionCustomMeetingPatternEntity
        ...
        - Frequency - set to frequency of pattern type.  For example, if pattern type is Weekly and recurring pattern is the same every week, then Frequency would be set to 1. If recurring pattern is every other week, then Frequency would be 2.
