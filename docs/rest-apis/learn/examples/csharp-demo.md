...
- You must
  [register your application](/docs/rest-apis/learn/admin/rest-and-learn.md) in Learn
...
- has a REST-enabled Learn instance, like the [Developer AMI](/docs/rest-apis/learn/sandbox/developer-ami.md).
...
1. Use the Application Key and Secret to obtain an OAuth 2.0 access token, as described in the [Basic Authentication](/docs/rest-apis/learn/getting-started/basic-authentication.md) document.
