  ...
  documentationSidebar: [
    ...
    // REST APIs
    {
      ...
      items: [
        ...
        // Learn
        {
          ...
          items: [
            ...
            // Sandbox
            {
              ...
              // collapsed: true,
              items: [
                "rest-apis/learn/sandbox/developer-ami",
              ],
            },
            // Learn App
            {
        ...
        // Premium APIs
        {
          ...
          // collapsed: true,
          items: [
            "rest-apis/premium-apis/rest_apis-learn-uef-request_premium_apis",
            {
              type: "category",
              label: "UEF",
              collapsible: true,
              items: [
                "rest-apis/premium-apis/uef/uef_getting_started",
                {
                  type: "autogenerated",
    ...
    // LTI
    {
      ...
      items: [
        "lti/lti-intro",
        "lti/lti-gs_with_lti",
        "lti/sanctioned-lti-registration-deployment",
        "lti/lti-registration-deployment",
        "lti/lti-deep_linking_two",
        "lti/lti-trouble-turn_on_all_switches",
        {
          type: "category",
          label: "Core",
          collapsible: true,
